...
public class WaterFrameBuffers {
	...
	public static int REFLECTION_WIDTH = 320;
	public static int REFLECTION_HEIGHT = 180;

	public static int REFRACTION_WIDTH = 320;
	public static int REFRACTION_HEIGHT = 180;
