...
import dev.moore.fightTerrors.playState.shadows.ShadowFrameBuffer;
...
public class ShadowMapMasterRenderer {
	...
	public static int SHADOW_EDGE_SMOOTHING = 1;
	 ...
	 */
	public void render(Map<TexturedModel, List<Entity>> entities, Map<TexturedModel, List<AnimatedEntity>> animEntities, Light sun) {
		shadowBox.update();
		Vector3f sunPosition = sun.getPosition();
		Vector3f lightDirection = new Vector3f(-sunPosition.x, -sunPosition.y, -sunPosition.z);
		prepare(lightDirection, shadowBox);
		entityRenderer.renderEntities(entities);
		entityRenderer.renderAnimEntities(animEntities);
		finish();
	}
