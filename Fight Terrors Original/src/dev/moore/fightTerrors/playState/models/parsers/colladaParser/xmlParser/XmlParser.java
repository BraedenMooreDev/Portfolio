package dev.moore.fightTerrors.playState.models.parsers.colladaParser.xmlParser;
...
public class XmlParser {
	...
	public static XmlNode loadXmlFile(String fileName) {
		...
		InputStream in = XmlParser.class.getResourceAsStream("/models/" + fileName + ".dae");
