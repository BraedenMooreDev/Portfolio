package dev.moore.fightTerrors.playState.models.parsers;
...
import dev.moore.fightTerrors.playState.models.base.Vertex;

public class objParser {

	public static ModelData loadOBJ(String objFileName) {

		InputStream in = objParser.class.getResourceAsStream("/models/" + objFileName + ".obj");
