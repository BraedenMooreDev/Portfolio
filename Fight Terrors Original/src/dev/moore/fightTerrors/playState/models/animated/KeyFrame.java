...
public class KeyFrame {
	...
	/**
	 * @param timeStamp      - the time (in seconds) that this keyframe occurs
	 *                       during the animation.
	 * @param jointKeyFrames - the local-space transforms for all the joints at this
	 *                       keyframe, indexed by the name of the joint that they
	 ...
	 *         of the animation, indexed by the name of the joint that they
	 *         correspond to. This basically represents the "pose" at this keyframe.
	 */
