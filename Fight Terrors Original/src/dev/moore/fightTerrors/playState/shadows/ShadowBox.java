package dev.moore.fightTerrors.playState.shadows;
...
public class ShadowBox {
	 ...
	 *                        "light" space (i.e. changes a point's coordinates from
	 *                        being in relation to the world's axis to being in
	...
	public void update() {
		...
		toNear.scale(PlayStateRenderer.NEAR_PLANE);
	 ...
	 * view frustum. However, this doesn't have to use the "actual" far plane of the
	...
	private void calculateWidthsAndHeights() {
		farWidth = (float) (SHADOW_DISTANCE * Math.tan(Math.toRadians(PlayStateRenderer.FOV)));
		nearWidth = (float) (PlayStateRenderer.NEAR_PLANE * Math.tan(Math.toRadians(PlayStateRenderer.FOV)));
